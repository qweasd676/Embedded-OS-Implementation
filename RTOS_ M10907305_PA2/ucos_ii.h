...
* MISSING in OS_CFG.H.  This allows you to quickly deter

e the source of the error.
*
...
//int task2_time;
//int task3_time;
//int task1_response_time;
//int task2_response_time;
//int task3_response_time;
//int task1_contextswitch;
//int task2_contextswitch;
//int task3_contextswitch;
//int sortQ2;
//int sortQ4;
...
int Aperiodic_exection_job1;
int Aperiodic_period_job1;
int Aperiodic_Arrival_job2;
int Aperiodic_exection_job2;
